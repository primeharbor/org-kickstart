...
* README slimmed to a project overview that links to [aws-kickstart.org](https://aws-kickstart.org) for full docs, with release/versioning info at the top; Future Work moved to `TODO.md`.
